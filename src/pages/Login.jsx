      ...
      >
        <div className="flex flex-col items-center text-center">
          ...
          <Link to="/" className="flex items-center gap-1.5 mb-6">
             <div className="bg-[#F05B43] text-white p-1 rounded">
             ...
             <span className="text-xl font-bold tracking-tight text-neutral-800 dark:text-neutral-100">Rajdoot</span>
          </Link>
        ...
        <div className="space-y-3">
          <button
            type="button"
            className="w-full flex items-center justify-center gap-2 bg-[#F3F4F6] dark:bg-neutral-800 hover:bg-[#E5E7EB] dark:hover:bg-neutral-700 text-neutral-700 dark:text-neutral-200 py-2.5 px-4 rounded-md text-sm font-medium transition-colors"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-neutral-500"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>
            Continue with SSO
          </button>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              ...
              <Link
                to="/forget-password"
                className="text-[13px] font-medium text-neutral-500 dark:text-neutral-400 hover:text-neutral-800 dark:hover:text-neutral-200"
              >
                Forgot password?
              </Link>
            </div>
          ...
          <div className="flex items-center pt-1 pb-1">
            ...
            />
            <label htmlFor="remember" className="ml-2 block text-sm text-neutral-600 dark:text-neutral-400 cursor-pointer select-none">
              Remember me
            </label>
          </div>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.99 }}
            type="submit"
            className="w-full bg-[#F05B43] hover:bg-[#E04D36] text-white rounded-md py-2.5 text-[15px] font-medium transition-colors shadow-sm"
          >
            Log in
          </motion.button>
        </form>
