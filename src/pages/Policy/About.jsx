      ...
      <div className="container mx-auto px-4 py-12">
        ...
        >
              ...
              <div className="flex flex-wrap gap-3">
                {skills.map((skill, index) => (
                  <motion.span
                    ...
                    className="px-4 py-2 bg-gray-800/50 text-gray-300 rounded-full text-sm border border-gray-700 hover:bg-gray-700/50 transition-colors"
                  >
                    {skill}
                  </motion.span>
                ))}
          ...
          <motion.div
            ...
            whileHover={{ y: -5 }}
            className="bg-gray-900/50 backdrop-blur-sm rounded-xl p-8 border border-gray-800 hover:border-gray-700 transition-all mb-16"
          >
            <h2 className="text-2xl font-bold text-white mb-6">My Vision</h2>
            <p className="text-gray-300 leading-relaxed">
