...
export const CodeBlock = ({ code }) => (
  <div className="bg-neutral-100 dark:bg-neutral-800 p-4 rounded-lg overflow-x-auto">
    <code className="text-sm text-neutral-900 dark:text-neutral-100">{code}</code>
  </div>
);
...
export const GettingStartedSection = () => {
  ...
  return (
    <motion.div
      ...
      variants={fadeInUp}
    >
      <h2 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100 mb-6">Getting Started with Rajdoot</h2>
      <div className="prose prose-invert max-w-none">
        ...
        <h3 className="text-xl font-semibold text-neutral-900 dark:text-neutral-100 mt-8 mb-4">Prerequisites</h3>
        ...
        <h3 className="text-xl font-semibold text-neutral-900 dark:text-neutral-100 mt-8 mb-4">Authentication</h3>
        <p className="text-neutral-700 dark:text-neutral-300 mb-4">
  ...
  'x-api-key': 'your_api_key_from_dashboard'
        ...
        <h3 className="text-xl font-semibold text-neutral-900 dark:text-neutral-100 mt-8 mb-4">Send Your First Message</h3>
        <p className="text-neutral-700 dark:text-neutral-300 mb-4">
...
export const AuthenticationSection = () => (
  <motion.div
    ...
    variants={fadeInUp}
  >
    <h2 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100 mb-6">Authentication</h2>
    <div className="prose prose-invert max-w-none">
      <p className="text-neutral-700 dark:text-neutral-300 mb-4">
      ...
      <h3 className="text-xl font-semibold text-neutral-900 dark:text-neutral-100 mt-8 mb-4">API Credentials</h3>
      <p className="text-neutral-700 dark:text-neutral-300 mb-4">
      ...
      <h3 className="text-xl font-semibold text-neutral-900 dark:text-neutral-100 mt-8 mb-4">Using Your Credentials</h3>
      <p className="text-neutral-700 dark:text-neutral-300 mb-4">
  ...
  'x-api-key': 'your_api_key_from_dashboard'
      ...
      <h3 className="text-xl font-semibold text-neutral-900 dark:text-neutral-100 mt-8 mb-4">Security Best Practices</h3>
      <ul className="list-disc pl-6 text-neutral-700 dark:text-neutral-300 mb-6">
...
export const DefaultSection = ({ title }) => (
  ...
  >
    ...
    <div className="prose prose-invert max-w-none">
      ...
      <div className="bg-neutral-100 dark:bg-neutral-800/50 backdrop-blur-sm rounded-xl p-6 border border-neutral-300 dark:border-neutral-700 mt-6">
        <h3 className="text-lg font-semibold text-neutral-900 dark:text-neutral-100 mb-4">Need Help?</h3>
        <p className="text-neutral-700 dark:text-neutral-300 mb-4">
